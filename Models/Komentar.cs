    ...
    public class Komentar
{
    ...
    // Veza sa korisnikom (Profesor/Asistent)
    [ForeignKey("Korisnik")]
    ...
    // Korisnici kojima je komentar vidljiv (ako je privatni)
